...
output_dir = 'feature_importance_plots_gbm'
...
for threshold in thresholds:
    ...
    plt.savefig(os.path.join(output_dir, f'GBM_feature_importance_threshold_{threshold}.png'))
    plt.close()
...
plt.ylabel('Accuracy')
plt.savefig(os.path.join(output_dir, 'GBM_accuracy_for_different_thresholds.png'))
plt.show()
